...
export const addTrainDetails = (newTrain: TrainDetails): Promise<ApiResponse<TrainDetails[]>> => {
  return new Promise((resolve) => {
    setTimeout(() => {
...
export const deleteTrainDetails = (id: number): Promise<ApiResponse<TrainDetails[]>> => {
  return new Promise((resolve) => {
    setTimeout(() => {
