      ...
      <div className="flex flex-col gap-6">
        <div className="flex flex-col md:flex-row items-start justify-between">
          <div className="w-full md:w-3/4 flex flex-col md:flex-row gap-4">
            ...
            <div className="flex flex-col gap-2">
              <h2 className="text-base font-semibold text-white">Planning your next trip?</h2>
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
          <div className="flex flex-wrap gap-4 text-white">
            {['About us', 'Mobile', 'Privacy', 'Terms of use', 'Career', 'Customer Service'].map((link) => (
          ...
          <div className="flex gap-2">
            {[FaSquareFacebook, FaLinkedin, FaGithubSquare, ImSkype, FaInstagramSquare].map((Icon, index) => (
              <Icon key={index} className="fill-[#E2E2ED] w-7 h-7 hover:scale-110 transition-transform cursor-pointer" />
            ))}
          </div>
        </div>
      </div>
