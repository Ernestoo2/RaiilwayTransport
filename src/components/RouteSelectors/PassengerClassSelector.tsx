...
import { ClassTypes, PassengerCount } from "../../utils/types/types";

export const PassengerClassSelector = () => {
    const [isOpen, setIsOpen] = useState(false);
    const [selectedClass, setSelectedClass] = useState<keyof ClassTypes>("Economy");
    ...
    const HandlePassengerUpdate = (
        ...
        setPassengerCount((prev) => {
            ...
            const newTotal =
                prev.adults + prev.children + prev.infants - prev[passengerType] + updatedCount;
        ...
        setClassPassengerTotals((prev) => {
            ...
            const newGrandTotal =
                prev.Economy + prev.Business + prev.FirstClass - prev[classType] + updatedTotal;
